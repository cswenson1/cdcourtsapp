              ...
              RichText(
                text: TextSpan(
                  children: <TextSpan>[
                    ...
                    TextSpan(text: '\n'),
                    TextSpan(
                      text: '2. First name and last name',
                    ),
                    TextSpan(text: '\n'),
                    TextSpan(
                      text: '3. Phone number',
                    ...
                    TextSpan(
                      text:
                          '2. Flash Cookies. Certain features of our Service may use local stored objects (or Flash Cookies) to collect and store information about Your preferences or Your activity on our Service. Flash Cookies are not managed by the same browser settings as those used for Browser Cookies. For more information on how You can delete Flash Cookies, please read "Where can I change the settings for disabling, or deleting local shared objects?" available at https://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash.html#main_Where_can_I_change_the_settings_for_disabling__or_deleting_local_shared_objects_',
                    ),
                    TextSpan(text: '\n'),
                    TextSpan(
                      text:
                          '3. Web Beacons. Certain sections of our Service and our emails may contain small electronic files known as web beacons (also referred to as clear gifs, pixel tags, and single-pixel gifs) that permit the Company, for example, to count users who have visited those pages or opened an email and for other related website statistics (for example, recording the popularity of a certain section and verifying system and server integrity).',
                    ),
                    TextSpan(text: '\n'),
                    TextSpan(text: '\n'),
                    TextSpan(
                    ...
                    TextSpan(text: '\n'),
                    TextSpan(
                      text: '1. Necessary / Essential Cookies',
                    ),
                    TextSpan(text: '\n'),
                    TextSpan(
                    ...
                    TextSpan(text: '\n'),
                    TextSpan(
                      text: '2. Cookies Policy / Notice Acceptance Cookies',
                    ),
                    TextSpan(text: '\n'),
                    TextSpan(
                    ...
                    TextSpan(
                      text:
                          'By email: cliff@cdcourtservices.com',
                    ),
                    TextSpan(text: '\n'),
                    TextSpan(
                      text:
